...
export const AvatarsGroup = () => {
  return (
    <AvatarGroup total={24}>
      ...
      <Avatar alt="Trevor Henderson" src={imageTemp} />
    </AvatarGroup>
  );
};

export const CircularProgressEle = () => {
  return (
...
export const LinearProgressEle = () => {
  return <LinearProgress determinate value={25} />;
};
